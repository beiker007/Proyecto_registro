...
export default class Cl_vUsuario extends Cl_vGeneral {
    ...
    private _vInvitados!: Cl_vInvitados;
    private _vEstudiantes!: Cl_vEstudiantes;
    private dataInvitados!: HTMLDivElement;
    private dataEstudiantes!: HTMLDivElement;
    private lblTotalRegistrados!: HTMLElement;
    private btAgregarInvitados!: HTMLButtonElement;
    ...
    this.dataInvitados = this.crearHTMLElement("dataInvitados", { type: tHTMLElement.CONTAINER, refresh: () => {} }) as HTMLDivElement;
    this.dataEstudiantes = this.crearHTMLElement("dataEstudiantes", { type: tHTMLElement.CONTAINER, refresh: () => {} }) as HTMLDivElement;
        this.lblTotalRegistrados = this.crearHTMLElement("lblTotalRegistrados") as HTMLElement;
